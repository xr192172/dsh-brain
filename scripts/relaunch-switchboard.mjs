...
// 用法： node scripts/relaunch-switchboard.mjs
...
const env = {
  ...
  DSH_PUBLIC_WEB_URL: 'http://127.0.0.1:3080',
  GEN_PORT_BASE: '3081',
  HANDOVER_ADMIN_PORT_BASE: '31810',
  SWITCH_ADMIN_PORT: '31800',
  DSH_HOME: 'C:\\Users\\Admin\\.dsh',
  VERIFY_ALLOW: 'C:\\Users\\Admin\\AppData\\Local\\Temp\\verifyout'
}
