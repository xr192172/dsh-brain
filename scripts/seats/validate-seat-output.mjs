...
if (asJson) {
  console.log(JSON.stringify({ seat, ok: r.ok, problems: r.problems }, null, 2))
...
console.log(`  ✗✗ 不合格（${r.problems.length} 条）：`)
for (const p of r.problems) console.log(`      [${p.code}] ${p.msg}`)
console.log('')
